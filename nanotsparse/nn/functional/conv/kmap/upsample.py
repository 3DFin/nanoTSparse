...
def spupsample_generative(
    ...
    sample_stride = make_tensor(stride, dtype=torch.int, device=_coords.device).unsqueeze(0)
    ...
    assert spatial_range is not None, "spatial range must be specified in generative mode"
