...
class GPUHashTable {
 ...
 public:
  ...
  at::Tensor lookup_coords(const at::Tensor& coords,
                           ...
                           const at::Tensor& tensor_strides, int kernel_volume);
...
using GPUHashMap = GPUHashTable<int64_t, int>;
using GPUHashMap32 = GPUHashTable<int, int>;
...
template <typename key_type, typename val_type>
at::Tensor GPUHashTable<key_type, val_type>::lookup_vals(
